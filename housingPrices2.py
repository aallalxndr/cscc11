...
#above is the code that is the advanced baseline from the Kaggle kernel below is what I added with XG boost to improve
#the numbers below for the regressor are just numbers picked and they can be improved by using a cross validation method
...
xgb = regr.predict(test_df_munged)



# Just going through different alphas and finding the alpha value that's best
best_alpha = 0.00099
...
#combinging the lasso function with XGBoost.

y_pred = (xgb + y_pred_lasso) / 2
